...
# ".cache/uni/notif-*" files: notifications
...
class Project:
	...
	publish(gn_namespace, project_name):
...
class ProjectView:
	...
	new(dirPath):
		...
		mainBox = Box(orient: HORIZONTAL)
		widget.setChild(mainBox)
		
		self.files = Files()
		mainBox.append(files)
		
		self.centerView = Stack()
